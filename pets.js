...
// let catsBtn = document.getElementById("cat")
// let dogsBtn = document.getElementById("dog")
// let dinosBtn = document.getElementById("dino")

// cat.addEventListener('click', buttonClicked);
// function buttonClicked(ev) {
//     console.log(ev.type, ev.target, ev.currentTarget)

// };

// dog.addEventListener('click', buttonClicked);
// function buttonClicked(ev) {
//     console.log(ev.type, ev.target, ev.currentTarget)
